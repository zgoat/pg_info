...
var packed = map[string][]byte{
	"tpl/activity.gohtml": []byte(`<h2 id="activity">pg_stat_activity</h2>
<p>
...
`),
	"tpl/dashboard.gohtml": []byte(`<!DOCTYPE html>
<html lang="en">
<head>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<title>pg_info</title>
	<link rel="stylesheet" href="{{.Prefix}}/all.css">
	<link rel="stylesheet" href="{{.Prefix}}/style.css">
</head>
<body>
	<nav>{{range $w := .Widgets}}
		<a href="{{$.Prefix}}}/widget/{{$w.Name}}">{{$w.Name}}</a>
	{{end}}</nav>

	<div class="page">
		{{range $w := .WidgetsHTML}}{{$w}}{{end}}
	</div>
...
`),
	"tpl/explain.gohtml": []byte(`<h2 id="explain">Explain</h2>
<div id="explain">
	<form method="post" action="{{.Prefix}}/explain">
		{{/*
...
`),
	"tpl/indexes.gohtml": []byte(`<h2 id="indexes">Indexes</h2>
<table class="sort">
<thead><tr>
	<th>Index</th>
	<th class="n">Size</th>
...
`),
	"tpl/progress.gohtml": []byte(`<h2 id="progress">pg_stat_progress_*</h2>
<table>
{{if gt (len .) 0}}
<thead><tr>
	<th>Table</th>
...
`),
	"tpl/statements.gohtml": []byte(`<h2 id="statements">pg_stat_statements
...
`),
	"tpl/system.gohtml": []byte(`<h2 id="system">System stats</h2>
<div id="system-stats">
	<pre>{{.Memory}}{{.LoadAvg}}</pre>
	<pre>{{.Disk}}</pre>
</div>
`),
	"tpl/tables.gohtml": []byte(`<h2 id="tables">Tables</h2>
<table class="sort">
<thead><tr>
	<th>Table</th>
...
`),
	"tpl/widget.gohtml": []byte(`<!DOCTYPE html>
<html lang="en">
<head>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<title>pg_info</title>
...
`),
	"public/script.js": []byte(`var pg_info = function() {
	// Sort tables
